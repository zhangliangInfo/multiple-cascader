...
function (_React$Component) {
  ...
  _createClass(MultipleCascader, [{
    ...
    value: function getClassActive(level) {
      ...
      var parentDOM = document.querySelector('.ant-cascader-menus');
    ...
    value: function getChildActiveIndexs() {
      ...
      function findActiveIndex() {
        ...
        if (index !== undefined) {
          ...
          options[index].children[childrenIndex[0]].children.forEach(function (o, idx) {
            stateValue.forEach(function (values) {
              if (values[2] == o.value) {
        ...
        console.log(secObj.childrenIndex); // 加上样式
    ...
    value: function handleChange(value, selectedOptions) {
      ...
      var _this$state = this.state,
          stateValues = _this$state.values,
    ...
    value: function handleContentKeyDown(e) {
      ...
      var refContent = this.refs.content;
    ...
    value: function handleHasInputChange(e) {
      e.stopPropagation();
      var width = getComputedStyle(this.refs.saveInputValue).width && getComputedStyle(this.refs.saveInputValue).width.split('px')[0] || 0;
      this.refs.privateInput.style.width = (e.target.value != '' ? width > 15 ? Math.ceil(width) : 15 : 5) + 'px';
      this.setState({
    ...
    value: function handleHasInputKeyDown(e) {
      ...
      var refContent = this.refs.content;
      var privateInput = this.refs.privateInput;
    ...
    value: function handleRemoveClick(idx) {
    ...
    value: function handleContentClick() {
      ...
      this.refs.privateInput.focus(); // selection.selectAllChildren(this.refs.content);
    ...
    value: function generateFilteredOptions() {
      ...
      var _this$props = this.props,
          ...
          showSearch = _this$props$showSearc === void 0 ? {} : _this$props$showSearc,
      ...
      var _this$state5 = this.state,
          _this$state5$flattenO = _this$state5.flattenOptions,
          flattenOptions = _this$state5$flattenO === void 0 ? [] : _this$state5$flattenO,
          inputValue = _this$state5.inputValue; // Limit the filter if needed
      ...
      if (limit > 0) {
        ...
        flattenOptions.some(function (path) {
          var match = filter(_this3.state.inputValue, path);
    ...
    value: function render() {
      ...
      var getFileItem = function getFileItem() {
        var labels = _this4.state.labels;

        if (labels.length) {
          return labels.map(function (value, idx) {
            return [React.createElement("div", {
              className: "ant-multiple-selected ant-multiple-selected-placeholder",
            ...
            }), React.createElement("span", null, _this4.defaultDisplayRender(value)), React.createElement("span", {
              className: "ant-multiple-suffix"
            }), _this4.closeIcon(idx))];
          });
        }
      };
      ...
      if (options && options.length > 0) {
        ...
        options = [(_ref4 = {}, _defineProperty(_ref4, names.label, 'Not Found'), _defineProperty(_ref4, names.value, 'ANT_CASCADER_NOT_FOUND'), _defineProperty(_ref4, "disabled", true), _ref4)];
      }
      ...
      return React.createElement(_cascader["default"], _extends({
        ...
        className: "ant-multiple-cascader"
      }, React.createElement("div", {
        ...
        onKeyDown: this.handleHasInputKeyDown // onBlur={this.handleInputBlur}
        ,
        value: this.state.inputValue,
        ref: "privateInput"
      }), React.createElement("div", {
        ref: "saveInputValue",
        className: "saveInputValue"
      }, this.state.inputValue)), React.createElement("div", {
        className: this.state.values.length || this.state.inputValue.length ? 'none mul-ant-input-place-text' : 'mul-ant-input-place-text',
        onClick: this.handlePlaceClick
      }, "\u8BF7\u9009\u62E9"), React.createElement(_icon["default"], {
        type: "down",
