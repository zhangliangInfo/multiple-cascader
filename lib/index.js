...
function (_React$Component) {
  ...
  _createClass(MultipleCascader, [{
    ...
    value: function getClassActive(level) {
      ...
      var parentDOM = document.querySelectorAll('.ant-cascader-menus')[index];
    ...
    value: function handleHasInputKeyDown(e) {
      ...
      var _this$state3 = this.state,
          ...
          inputValue = _this$state3.inputValue; // let count = values.length;

      var refContent = this.refs.content;
      var privateInput = this.refs.privateInput;
      console.log('inputKeycode', keyCode); // return;
    ...
    value: function handleContentClick() {
      ...
      this.refs.content.focus(); // this.refs.privateInput.focus();

      selection.selectAllChildren(this.refs.content); // selection.collapseToEnd();
