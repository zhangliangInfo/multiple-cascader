...
function (_React$Component) {
  ...
  function MultipleCascader(props) {
    ...
    _this2.clearSelection = _this2.clearSelection.bind(_assertThisInitialized(_this2));
    _this2.state = {
      values: [],
      labels: [],
      isModify: false,
  ...
  _createClass(MultipleCascader, [{
    ...
    value: function clearSelection(e) {
      ...
      var _this$state4 = this.state,
          ...
          isModify = _this$state4.isModify;
    ...
    value: function generateFilteredOptions() {
      ...
      return [(_ref3 = {}, _defineProperty(_ref3, names.value, 'ANT_CASCADER_NOT_FOUND'), _defineProperty(_ref3, names.label, notFoundContent), _defineProperty(_ref3, "disabled", true), _defineProperty(_ref3, "isEmptyNode", true), _ref3)];
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var clearIcon = props.allowClear && !props.disabled && state.values.length > 0 || state.inputValue ? React.createElement(_icon["default"], {
        className: "ant-multiple-picker-clear",
        type: "close-circle",
        onClick: this.clearSelection
      }) : null;
      var pickerCls = (0, _classnames["default"])('ant-multiple-cascader', _defineProperty({
      ...
      if (cascaderOptions && cascaderOptions.length > 0) {
        ...
        cascaderOptions = [(_ref4 = {}, _defineProperty(_ref4, names.label, props.notFoundContent), _defineProperty(_ref4, names.value, 'ANT_CASCADER_NOT_FOUND'), _defineProperty(_ref4, "disabled", true), _ref4)];
      }
      ...
      return React.createElement(_cascader["default"], _extends({
        ...
        className: "ant-multiple-cascader-text-wrap"
        ...
        ref: "saveInputValue",
        className: "ant-multiple-cascader-text-save"
      }, state.inputValue)), React.createElement("div", {
        className: state.values.length || state.inputValue.length ? 'none ant-multiple-input-place-text' : 'ant-multiple-input-place-text',
        onClick: this.handlePlaceClick
      }, placeholder)), clearIcon, React.createElement(_icon["default"], {
        type: "down",
