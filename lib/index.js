  ...
  _createClass(MultipleCascader, [{
    ...
    value: function handleContentKeyDown(e) {
      ...
      if (keyCode == 37 || keyCode == 39 || keyCode == 8 || keyCode == 46) {
        ...
        var _this$refs = this.refs,
            ...
            inputObj = _this$refs.inputObj; // 37 left, 39 right
    ...
    value: function handleContentClick() {
      ...
      if (values.length) {
        ...
        refContent.focus();
        selection.selectAllChildren(refContent); // selection.collapseToEnd();
    ...
    value: function render() {
      ...
      return React.createElement(_cascader["default"], _extends({
        ...
        className: this.state.values.length || this.state.inputValue.length ? 'none multiple-ant-input-place-text' : 'multiple-ant-input-place-text',
